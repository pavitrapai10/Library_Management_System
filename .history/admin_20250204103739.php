            ...
            <tbody>
                <?php while ($row = $users_result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <a href="edit_user.php?id=<?php echo $row['id']; ?>" class="edbutton edit-button">Edit</a>
                        <?php else: ?>
                        <button class="wbutton disabled-button" disabled>Edit</button>
                        <?php endif; ?>

                        <?php if ($user['role'] === 'Admin'): ?>
                        <a href="delete_user.php?id=<?php echo $row['id']; ?>" class="button delete-button" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                        <?php endif; ?>
                        </td>
