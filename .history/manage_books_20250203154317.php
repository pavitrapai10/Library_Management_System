...
<body>
    <header>
        ...
        <a href="my_borrowed_books.php" class="button">My Borrowed Books</a>
                ...
                <tbody>
                    <?php while ($row = $books_result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <?php echo ($borrowedResult->num_rows > 0) ? 'style="color:gray; pointer-events:none;"' : ''; ?>>Borrow</a>
                            </td>
    <td>
        <a href="manage_books.php?return_book_id=<?php echo $row['id']; ?>" 
           <?php echo ($borrowedResult->num_rows == 0) ? 'style="color:gray; pointer-events:none;"' : ''; ?>>Return</a>
    <?php endif; ?>
</td>
