                    ...
                    <?php while ($row = $books_result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <!-- Show Borrow or Return option for regular users -->
                                    <?php
                                    ...
                                    ?>
                                    <?php if ($borrowedResult->num_rows > 0): ?>
                                        <a href="manage_books.php?return_book_id=<?php echo $row['id']; ?>">Return</a>
                                    <?php else: ?>
                                        <a href="manage_books.php?borrow_book_id=<?php echo $row['id']; ?>">Borrow</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </td>
                        </tr>
