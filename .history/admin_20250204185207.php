...
<header>
    ...
    <td>
        <?php if ($row['username'] === $_SESSION['username'] && $user['role_id'] !== 'Admin'): ?>
            <!-- Regular user editing their own details -->
        ...
        <?php if ($row['username'] !== $_SESSION['username'] && $user['role'] !== 'Admin'): ?>
            <!-- For other regular users, disable edit -->
